...
var slide = 
{
	...
	width: 900,
	height: 300,
	//style: "animation: fadeout 6s infinite; width: 900px; height: 300px",
	
	// thời gian hiển thị của mỗi ảnh trên slide (giây)
	show_duration : 6,
    ...
    showImg: function (j) {
		...
		//document.getElementById(this.id).style= "animation: fadeout 5s;";
	...
	previous_next_icons: function() {
			...
			document.write('<img src="../../baitap/microsoft/assets/js/'+this.img_previous+'" onClick="slide.previous();" /><img src="../../baitap/microsoft/assets/js/'+this.img_next+'" onClick="slide.next();" />');
	...
	run: function() {
		...
		document.write('<br />');	// Xuống dòng
		//document.write('<img id="'+this.id+'" src="../../baitap/microsoft/assets/js/'+this.imgs[0]+'" width="'+this.width+'" style="'+this.style+'"/>');	
